...
function createImage(url) {
  return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(function (deferred) {
    ...
    $img.one('load', function () {
      ...
      display: 'none'
    }).appendTo(document.body).attr('src', url)//.attr('loading',"lazy");
  }).promise();
}
  ...
  function Editor(context) {
    ...
    this.createLink = this.wrapCommand(function (linkInfo) {
      ...
      external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(anchors, function (idx, anchor) {
        ...
        if (isNewWindow) {
          external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(anchor).attr('target', '_blank').attr('rel', 'noopener');
        } else {
    ...
    value: function initialize() {
      this.$popover = this.ui.popover({
        ...
        callback: function callback($node) {
          ...
          $content.prepend('<span><a target="_blank" rel="noopener"></a>&nbsp;</span>');
        }
